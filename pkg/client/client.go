...
// OAuth2Token 交换访问令牌
func (c *AuthClient) OAuth2Token(ctx context.Context, grantType, code, redirectURI, clientID, clientSecret, refreshToken, scope, codeVerifier string) (*proto.OAuth2TokenResponse, error) {
	req := &proto.OAuth2TokenRequest{
		GrantType:    grantType,
		Code:         code,
...
func (c *AuthClient) OIDCUserInfo(ctx context.Context, accessToken string) (*proto.OIDCUserInfoResponse, error) {
	req := &proto.OIDCUserInfoRequest{
...
func (c *AuthClient) ParseIDToken(idToken string) (*proto.OIDCUserInfoResponse, error) {
	if idToken == "" {
	...
	userInfo := &proto.OIDCUserInfoResponse{}
...
func (c *AuthClient) ValidateAndParseIDToken(ctx context.Context, idToken string) (*proto.OIDCUserInfoResponse, error) {
	if idToken == "" {
		return nil, fmt.Errorf("id_token is required")
	}
...
func parseRSAPublicKey(jwk *proto.OIDCJwk) (*rsa.PublicKey, error) {
	if jwk.Kty != "RSA" {
...
func (c *AuthClient) parseAndValidateClaims(idToken string) (*proto.OIDCUserInfoResponse, error) {
	parts := strings.Split(idToken, ".")
	if len(parts) != 3 {
...
func (c *AuthClient) OIDCDiscovery(ctx context.Context) (*proto.OIDCDiscoveryResponse, error) {
	req := &emptypb.Empty{}
