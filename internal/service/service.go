...
func (o *OAuth2Service) buildTokenResponse(ctx context.Context, accessToken, refreshToken string, scope pgtype.Text, includeIDToken bool, userID int64, clientID, nonce string) (*dto.OAuth2TokenResponse, error) {
